...
@Composable
fun formularioClientes(navController: NavController){
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = {
                    Text("Insertar Cliente", fontSize = 22.sp, color = Color.White)
                },
                navigationIcon = {
        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    val cliente = Cliente(nombre, NIF, NombreEmpresa, TipoEmpresa, Fecha, Direccion, cp.toInt(), Localidad, Pais, 0)
                    // Llama a la función del ViewModel para guardar el cliente
                    viewModel.guardarClienteEnBaseDeDatos(cliente)
